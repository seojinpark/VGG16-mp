...
class CostSim:
    ...
    def searchMultiChain(self, startLayer, startConfig, globalBatch: int, totalGpus: int):
        ...
        # print(optionListSizeList)
        # avgOptionListSize = (sum(optionListSizeList) + 0.0) / len(optionListSizeList)
